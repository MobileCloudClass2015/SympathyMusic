...
public class ModeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton manage = (ImageButton)findViewById(R.id.friends_manage);
        ImageButton friendsList = (ImageButton)findViewById(R.id.friends_list);
        ...
        recomd.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), FriendsRecommendList.class);
        ...
        manage.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), FriendsManegeList.class);
                startActivityForResult(intent, 0);
            }
        });
        friendsList.setOnClickListener(new Button.OnClickListener() {
